    ...
    return (
        <div className="modal-card">
            ...
            <section className="modal-card-body">
                <h1 className="subtitle">This is your second passphrase. It will be requested to sign any transaction from now on.</h1>
                <strong>
                    {secondPassphrase!
                        .split(" ")
                        .map((word: string, i: number, origArr: string[]) =>
                            <span className="passphrase-word" key={i}>
                                {word}{i === origArr.length - 1 ? '': " "}
                          </span>
                        )}
                </strong>
                <p className="top25">Make sure to store this second passphrase safely. If you lose the passphrase, you'll lose the ability to transfer your funds. Do you want to confirm the operation?</p>
            </section>
