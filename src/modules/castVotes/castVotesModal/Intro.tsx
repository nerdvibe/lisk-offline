...
import image from "./img/undraw_following_q0cr.svg"
    ...
    return (
        <div className="modal-card">
            ...
            <section className="modal-card-body">
                ...
                <h1 className="subtitle"> Do you have at least 1 LSK in this wallet? </h1>
            </section>
            <footer className="modal-card-foot">
                <button className="button is-info is-outlined" onClick={closeModal}>No, cancel</button>
                <button className="button is-success is-outlined" onClick={nextStep}>Yes, let's vote</button>
            </footer>
        </div>
    );
}
